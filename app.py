...
# Dashboard Settings (location, Vevor, screensaver) - UI-editable via /settings
...
def _disable_cache_for_dashboard(response):
    ...
    if request.path in ("/", "/5day", "/ha", "/ha/settings", "/settings") and response.content_type and "text/html" in response.content_type:
